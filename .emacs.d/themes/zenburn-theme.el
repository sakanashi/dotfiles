...
;;;;; isearch
   ...
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-2
                      ...
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background ,zenburn-region))
             (t :inverse-video t)))
...
;;;;; font lock
   ...
   `(font-lock-constant-face ((t (:foreground ,zenburn-blue+3))))
   `(font-lock-doc-face ((t (:foreground ,zenburn-green+2))))
   `(font-lock-function-name-face ((t (:foreground ,zenburn-green))))
   ...
   `(font-lock-string-face ((t (:foreground ,zenburn-blue))))
...
;;;;; line numbers (Emacs 26.1 and above)
   `(line-number ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg-05))))
...
;;;;; git-gutter
   `(git-gutter:added ((t (:foreground ,zenburn-green :weight bold ((t (:inverse-video t)))))))
   `(git-gutter:deleted ((t (:foreground ,zenburn-red :weight bold ((t (:inverse-video t)))))))
   `(git-gutter:modified ((t (:foreground ,zenburn-magenta :weight bold ((t (:inverse-video t)))))))
   `(git-gutter:unchanged ((t (:foreground ,zenburn-fg :weight bold ((t (:inverse-video t)))))))
